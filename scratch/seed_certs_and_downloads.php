...
foreach ($downloads as $index => $dl) {
    // Check if Download model uses type, size, category or if we should just stick them in description
    try {
        ...
        echo 'Error saving download: '.$e->getMessage()."\n";
    }
}

echo "Certificates and Downloads seeded successfully.\n";
